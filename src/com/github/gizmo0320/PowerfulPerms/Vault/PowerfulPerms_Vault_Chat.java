package com.github.gizmo0320.PowerfulPerms.Vault;
...
import com.github.gizmo0320.PowerfulPerms.PowerfulPerms;
...
public class PowerfulPerms_Vault_Chat extends Chat {
    ...
    public String getPlayerVaultVariable(String playerName, String node, String world) {
        if (PowerfulPerms.vault_offline) {
            ...
            if (uuid == null)
                return null;
            try {
                List<com.github.gizmo0320.PowerfulPermsAPI.Permission> permissions = permissionManager.getPlayerOwnPermissionsBase(uuid);
            ...
            if (p != null) {
                List<com.github.gizmo0320.PowerfulPermsAPI.Permission> permissions = p.getPermissions();
                return getVaultVariable(permissions, node, world);
            }
        }
        return null;
    ...
    public String getVaultVariable(List<com.github.gizmo0320.PowerfulPermsAPI.Permission> permissions, String node, String world) {
        for (com.github.gizmo0320.PowerfulPermsAPI.Permission p : permissions) {
